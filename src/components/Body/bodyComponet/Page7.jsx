...
const Page_7 = () => {
  ...
  return (
    <div className="body_7-box" style={{paddingTop:'3em',paddingBottom:'3em'}}>
      {/* 타이틀 */}
        <div className="body_7-title">
            <span>
                <span>7. </span>
                앱스타인 기형 합병증
            </span>
        </div>
        <div className="body_7-info">
            {/*  */}
            
            <div className="body_7-top-text">
              {/* 상단 text */}
              앱스타인 기형을 가지고 태어난 환자는 다음과 같은 심장 문제를 겪을 수 있습니다.
            </div>

            <div className="body_7-bottom-box">
              <div className="body_7-text-box">
                {/* 심방 중격 결손증 */}
                <h3>심방 중격 결손증</h3>
                <p>
...
const ImgBox = ({link}) => {
  ...
  return (
    <div className="page7-img-box">
      <div className="page7-img-card" style={{width:'300px', height:'300px'}}>
        <img src={link} />
      </div>
      <div className="page7-img-text">
      </div>
    </div>
  );
}
